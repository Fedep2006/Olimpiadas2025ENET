...
@else
    @foreach ($registros as $registro)
        <tr>
            ...
            <td>{{ $registro->fecha_salida->format('d/m/Y H:i') }}</td>
            <td>{{ $registro->fecha_llegada->format('d/m/Y H:i') }}</td>
            <td>{{ $registro->empresa }}</td>
            <td>{{ $registro->numero_viaje }}</td>
            <td>{{ $registro->capacidad_total }}</td>
            <td>{{ $registro->asientos_disponibles }}</td>
