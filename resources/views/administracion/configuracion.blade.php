...
<body>
    ...
    <div class="admin-sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="/administracion/configuracion" class="menu-item  active">
                ...
                <div class="config-section">
                    ...
                    <div class="setting-item">
                        <div class="setting-info">
                            ...
                            <div class="setting-description">Permitir que nuevos usuarios se registren en la plataforma
                            </div>
                        </div>
                ...
                <div class="config-section">
                    ...
                    <div class="setting-item">
                        <div class="setting-info">
                            ...
                            <div class="setting-description">Aceptar pagos con tarjetas Visa, MasterCard, American
                                Express</div>
                        </div>
                        <label class="toggle-switch">
                            <input type="checkbox" checked>
