...
<head>
    <meta charset="UTF-8">
    <title>Reserva de hospedaje enviada - Frategar</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>¡Reserva de hospedaje enviada!</h2>
            <p>Tu solicitud de reserva de hospedaje fue recibida correctamente.<br>
            ...
            <p style="margin-top: 32px; font-size: 1.05rem;">
                <b>Detalle del hospedaje:</b><br>
                Nombre: <b>{{ $hospedaje->nombre }}</b><br>
                Ciudad: <b>{{ $hospedaje->ciudad->nombre ?? '-' }}</b><br>
                Fecha de entrada: <b>{{ $reserva->fecha_inicio }}</b><br>
                Fecha de salida: <b>{{ $reserva->fecha_fin }}</b><br>
                Cantidad de personas: <b>{{ $reserva->personasConReservas->count() ?? '-' }}</b><br>
